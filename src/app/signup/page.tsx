    ...
    <main className="mx-auto max-w-md px-4 py-16">
      <div className="card text-center">
        ...
        <p className="mt-3 text-slate-600">
          The Automated I.T. Solutions Events APP is currently invite-only. If you'd like to host
          your events on this platform, please contact us and we'll get you set up.
        </p>
        <div className="mt-6 space-y-2 text-sm">
          <div>
            <a href="mailto:AITS-Events@automateditsolutions.net" className="btn-primary inline-block">
