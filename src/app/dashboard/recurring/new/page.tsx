    ...
    <main className="mx-auto max-w-3xl px-4 py-8">
      ...
      {searchParams?.bought === "RECURRING_EVENT_CREDIT" && (
        <div className="mb-4 rounded-lg bg-emerald-50 p-4 text-sm text-emerald-800 ring-1 ring-emerald-200">
          ...
          Schedule up to 12 sessions (or add an all-sessions pass) below to use one.
        </div>
      )}
      ...
      <div className="mb-6 grid gap-3 sm:grid-cols-2">
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <div className="flex items-center justify-between">
            ...
            <span className="rounded-full bg-emerald-100 px-2 py-0.5 text-xs text-emerald-700">No credit needed</span>
          </div>
          <ul className="mt-2 space-y-1 text-sm text-slate-600">
            <li>✓ <strong>Up to 2 sessions</strong> per recurring event</li>
          ...
          <p className="mt-3 text-xs text-slate-400">Create as many free recurring events as you like — 2 sessions each.</p>
        </div>
        ...
        <div className="rounded-xl border-2 border-brand-300 bg-brand-50/50 p-4">
          ...
          <ul className="mt-2 space-y-1 text-sm text-slate-700">
            <li>✓ <strong>Up to 12 sessions</strong> in one recurring event</li>
          ...
          {credits > 0 ? (
            <p className="mt-3 text-xs font-medium text-emerald-700">
              You have {credits} credit{credits === 1 ? "" : "s"} ready — schedule more than 2 sessions below to use one.
            </p>
          ) : (
