...
const schema = z.object({
  ...
  recurringEventCredits: z.coerce.number().int().min(0).max(100_000),
...
export async function editOrgSubscriptionAction(formData: FormData) {
  ...
  await prisma.organization.update({
    ...
    data: {
      ...
      recurringEventCredits: data.recurringEventCredits,
  ...
  await audit({
    ...
    metadata: {
      before: {
        ...
        recurringEventCredits: org.recurringEventCredits,
