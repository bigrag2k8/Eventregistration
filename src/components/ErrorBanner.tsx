...
const MESSAGES: Record<string, string> = {
  ...
  plan_limit: "Your plan's monthly event limit is reached. Upgrade or buy a Premium Event credit in Billing.",
  no_credits: "You don't have a Premium Event credit to spend. Buy one in Billing, then try again.",
